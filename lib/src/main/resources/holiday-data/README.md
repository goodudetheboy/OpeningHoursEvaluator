...
This holdiday data was taken from [date-holidays](https://github.com/commenthol/date-holidays)'s data, specifically [here](https://github.com/commenthol/date-holidays/tree/master/data/countries). Although the original data was in YAML file format, I have converted it beforehand to JSON for ease of use. The original data there is licensed under CC BY-SA 3.0., and listed below are attributions from the `*.yaml` files there:
...
https://de.m.wikipedia.org/wiki/Feiertage_in_Frankreich
...
https://fr.wikipedia.org/wiki/F%C3%AAtes_et_jours_f%C3%A9ri%C3%A9s_en_Tunisie

https://fr.wikipedia.org/wiki/Guadeloupe#C%C3%A9l%C3%A9brations,_festivit%C3%A9s_et_jours_f%C3%A9ri%C3%A9s

https://fr.wikipedia.org/wiki/Guin%C3%A9e#Jours_f%C3%A9ri%C3%A9s

https://fr.wikipedia.org/wiki/Jour_f%C3%A9ri%C3%A9#Mali

https://fr.wikipedia.org/wiki/Jours_f%C3%A9ri%C3%A9s_au_Rwanda
